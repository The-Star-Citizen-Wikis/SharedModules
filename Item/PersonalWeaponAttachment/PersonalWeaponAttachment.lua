...
local data = mw.loadJsonData( 'Module:Item/PersonalWeaponAttachment/data.json' )
...
local function translate( key, addSuffix, ... )
    return TNT:translate( 'Module:Item/PersonalWeaponAttachment/i18n.json', config, key, addSuffix, {...} )
end
...
function PersonalWeaponAttachment.addSmwProperties( apiData, frameArgs, smwSetObject )
...
--- @return void
function PersonalWeaponAttachment.addSmwAskProperties( smwAskObject )
...
--- @param smwData table Data from Semantic MediaWiki
--- @return void
function PersonalWeaponAttachment.addCategories( categories, frameArgs, smwData )
...
--- @param smwData table Data from Semantic MediaWiki
--- @return string|nil
function PersonalWeaponAttachment.getShortDescription( frameArgs, smwData )
